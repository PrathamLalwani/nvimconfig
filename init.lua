...
Balls:register("https://github.com/honza/vim-snippets")
Balls:register("https://github.com/Shougo/deoplete.nvim")
Balls:register("https://github.com/hrsh7th/nvim-cmp")
Balls:register("https://github.com/hrsh7th/cmp-nvim-lsp")
Balls:register("https://github.com/SirVer/ultisnips")
Balls:register("https://github.com/quangnguyen30192/cmp-nvim-ultisnips")
local cmp_installed, cmp = pcall(require, "cmp")
local ultisnips_installed, ultisnip = pcall(require, "cmp_nvim_ultisnips")
if cmp_installed then
...
-- ultisnip.setup({
--   config = function()
--     vim.g.UltiSnipsSnippetDirectories = { "~/.config/nvim" }
--     vim.g.UltiSnipesExpandTrigger = '<Tab>'
--   end,
...
local vimrc = vim.fn.stdpath("config") .. "/after/latex.vim"
